    ...
    {   
        ...
        if ($request->lang && $request->lang == 'zh'){
            ...
            $data = [
                ...
                'page_wheel_text' => '支付池的总价值是 '.env('POOL').' AZW，每次旋转后都会减少。 我们将根据市场价格向您发送相应的代币。 注意: 幸运轮是AZ World APP的额外功能它是自动平衡系统 (数量-奖励池-用户）: 现在旋转时间是48小时',
