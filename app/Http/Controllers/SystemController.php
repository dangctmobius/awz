...
{   
    ...
    {   
        ...
        $data = [
            ...
            'page_wheel_text' => 'You will get lucky spin after 34 hours. The total value of the payout pool is '.env('POOL').' AZW, which will decrease after each spin. When you spin how many USDT, we will send you the corresponding token according to the market price.\nNote: Lucky Wheel is extra function of AZ World APP It is auto-balance system ( Volume - Reward Pool - Users ) : Time to spin now is 34 hours',
        ...
        if ($request->lang && $request->lang == 'zh'){
            ...
            $data = [
                ...
                'page_wheel_text' => '34 小时后您将获得幸运旋转. 支付池的总价值为 '.env('POOL').' AZW, 每次旋转后会减少。当您旋转多少USDT时，我们将根据市场价格向您发送相应的代币.\n注：幸运轮是AZ World APP的附加功能 它是自动平衡系统（数量 - 奖励池 - 用户）：现在旋转的时间是 34 小时',
